...
async fn main() {
    ...
    use basic_service::app::{AppState, Config};
    ...
    basic_service::register_panic_logger();
    basic_service::report_version();
    ...
    let (graceful_waiter, shutdown_rx) = basic_service::graceful_shutdown_blocker();
    let mut handles = Vec::new();

    let server = basic_service::server(
